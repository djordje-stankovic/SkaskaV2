...
## Viber / WhatsApp – preview slike (link pri deljenju)

**Šta je urađeno u kodu:**
- Na sve stranice (EN i SR) dodat je **`og:image:type`** = `image/jpeg` – Viber voli eksplicitnu vrstu slike.
- Već postoje **`og:image:width`** i **`og:image:height`** (1200×630).

**Ako se slika i dalje ne vidi na Viber-u:**
